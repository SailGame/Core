...
func TestRoom(t *testing.T) {
    Convey("Room", t, func() {
        ...
        So(err, assertions.ShouldBeNil)
        So(createRoomRet.Errno, assertions.ShouldEqual, core.ErrorNumber_OK)
        ...
        So(err, assertions.ShouldBeNil)
        So(listRoomRet.Errno, assertions.ShouldEqual, core.ErrorNumber_OK)
        ...
        So(err, assertions.ShouldBeNil)
        So(joinRoomRet.Errno, assertions.ShouldEqual, core.ErrorNumber_OK)
        ...
        So(err, assertions.ShouldBeNil)
        So(listRoomRet2.Errno, assertions.ShouldEqual, core.ErrorNumber_OK)
        So(len(listRoomRet.GetRoom()), assertions.ShouldEqual, 1)
